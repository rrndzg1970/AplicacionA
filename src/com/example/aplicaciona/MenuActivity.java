...
import com.example.aplicaciona.util.SystemUiHider;
...
public class MenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final View controlsView = findViewById(R.id.ly1);
		final View contentView = findViewById(R.id.ly1);
	...
	public void myClickHandler(View v){
		Log.d("Rafa", "Veamos ");
		Toast toast=Toast.makeText(this, "veamos dijo un ... ", Toast.LENGTH_SHORT);
    	toast.show();
    }	
	
	public void onClick(View v) {
		Log.d("Rafa", "Veamos onClick .... ");
	    switch (v.getId()) {
	    case R.id.button1:
	    	showToastMessage(2);
	        break;
